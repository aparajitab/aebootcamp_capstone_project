...
// Validate ../../app/api/launchdarkly/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/launchdarkly">> = Specific
  const handler = {} as typeof import("../../app/api/launchdarkly/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
