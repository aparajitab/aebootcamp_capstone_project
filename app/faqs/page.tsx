    ...
    <div className="h-screen bg-background flex flex-col overflow-hidden">
      ...
      <div className="bg-gray-50 px-4 py-3 border-b">
        <div className="max-w-7xl mx-auto flex items-center gap-8">
          ...
          <Link href="/faqs" className="text-xs font-medium text-blue-600 font-bold">
            FAQs
          </Link>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="flex-1 overflow-y-auto">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">FAQs - Feature Flags & Experiments</h2>
          <p className="text-gray-600 mb-8">Ask any question about Feature Flags and Experiments supported by LaunchDarkly. Our RAG-powered agent will provide answers.</p>
            ...
            <form onSubmit={handleAskQuestion} className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  placeholder="Ask about feature flags, experiments, LaunchDarkly, or anything else..."
                  rows={4}
